...
fn random_scene<R: Rng>(mut rng: R) -> Scene {
    ...
    objects.push(Sphere::new(Point3::new(-4., 1., 0.), 1.0, material1));
    let material2 = Material::dielectric(1.5);
    objects.push(Sphere::new(Point3::new(0., 1., 0.), 1.0, material2));
    let material3 = Material::metal(Vec3::new(0.7, 0.6, 0.5), 0.0);
    objects.push(Sphere::new(Point3::new(4., 1., 0.), 1.0, material3));
